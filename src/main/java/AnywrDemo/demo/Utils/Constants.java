package AnywrDemo.demo.Utils;

public interface Constants {

    String APP_ROOT = "anywrDemo/v1";
...
//    String DELETE_COMMANDE_FOURNISSEUR_ENDPOINT = COMMANDE_FOURNISSEUR_ENDPOINT + "/delete/{idCommandeFournisseur}";
    ...
    String COLLABORATOR_ENDPOINT = APP_ROOT + "/collaborator";
    ...
    String PASSWORD_RESET = APP_ROOT ;

    String ROLESET_COLLABORATOR = APP_ROOT;
}
